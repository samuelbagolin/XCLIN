    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-6">
          <div className="medical-card p-8 max-w-md w-full bg-white text-center space-y-6 animate-in fade-in zoom-in duration-300">
            ...
            {this.state.error && (
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 text-[10px] text-slate-400 font-mono break-all max-h-24 overflow-y-auto">
